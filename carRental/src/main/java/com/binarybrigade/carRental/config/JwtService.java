...
public class JwtService {
    ...
    public String createToken(User userDetails){ //create token without extract claims
    ...
    public String createToken(Map<String,Object> extractClaims, User userDetails){

        extractClaims.put("name", userDetails.getUsername());
        extractClaims.put("userid", userDetails.getId());
